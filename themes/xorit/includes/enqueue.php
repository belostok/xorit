...
namespace xoritTheme\Enqueue;

use function xoritTheme\Helpers\get_version;
...
function preload_font() {
	...
	<link
		rel="preload"
		href="<?php echo esc_url( XORIT_TEMPLATE_URL . 'build/fonts/BigShouldersDisplay-Variable.woff2' ); ?>"
		as="font"
...
function enqueue_scripts() {
	...
	wp_enqueue_style(
		'xorit-front-styles',
		XORIT_TEMPLATE_URL . 'build/front.css',
		[],
		$ver
	);
	...
	wp_enqueue_script(
		'xorit-front-scripts',
		XORIT_TEMPLATE_URL . 'build/front.js',
		[],
		$ver,
		true
	);
	...
	wp_enqueue_script(
		'xorit-front-delayed-scripts',
		XORIT_TEMPLATE_URL . 'build/front-delayed.js',
		[],
		$ver,
		true
	);
	...
	wp_localize_script(
		...
		[
			...
			'nonce' => wp_create_nonce( 'xorit-nonce' ),
		]
	);
}
...
function admin_enqueue_scripts() {
	...
	wp_enqueue_style(
		'xorit-admin-styles',
		XORIT_TEMPLATE_URL . 'build/admin.css',
		[],
		$ver
	);
	...
	wp_enqueue_script(
		'xorit-admin-scripts',
		XORIT_TEMPLATE_URL . 'build/admin.js',
		[ 'jquery' ],
		$ver,
		true
	);
